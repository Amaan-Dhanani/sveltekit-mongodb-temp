...
<div
	class="fixed inset-0 -z-[100] mt-[100vh] h-[300vh] w-screen overflow-hidden bg-primary"
></div>
<div class="mr-[1rem] ml-[1rem] flex min-h-screen flex-col bg-primary">
	<!-- Header -->
	...
	>
			<div class="gap-0 dark:text-white">
				...
				>
					<button
						type="submit"
						class="mt-[20px] h-12 w-full rounded-xl bg-primary text-center text-white hover:cursor-pointer"
					>
						My Quests
					</button>
					<button
